...
contract Share is ERC20Burnable, Operator {
    ...
    address public immutable PairTEST;
    ...
    constructor(address _BOND, address _TEST, address _USDC, address _router, address _genesisAddress, address _treasury, address _boardroom, address _shareRewardPool, uint256 _startTime, address _communityFund, address _devFund) ERC20("Test Share", "TSHARE") {
        ...
        PairTEST = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), address(TEST));

        TEST.setPairDshare(PairTEST);
    ...
    function setWhiteList(address _WhiteList) public onlyAdmin {
        ...
        require(PairTEST != _WhiteList, "set tax to 0 if you want to remove fee from trading");
